    ...
    <div class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div class="mb-10 flex items-center justify-between">
            ...
            <div class="hidden sm:block">
                <span
                    class="inline-flex items-center gap-2 px-3 py-1 bg-green-500/10 border border-green-500/20 rounded-full text-[10px] font-black uppercase tracking-widest text-green-500">
        ...
        <div class="grid gap-8 lg:grid-cols-3">
                ...
                <div class="relative overflow-hidden rounded-3xl border border-slate-800 bg-slate-900 shadow-2xl">
                    ...
                    <div class="relative flex flex-col gap-8 p-8 sm:flex-row sm:items-center">
                        <div class="relative h-32 w-32 shrink-0">
                            <div
                                class="h-full w-full overflow-hidden rounded-2xl border-2 border-slate-700 bg-slate-800 shadow-xl">
                                @if($avatar)
                                    <img src="{{ $avatar }}" alt="{{ $name }}"
                                        class="h-full w-full object-cover scale-105 group-hover:scale-110 transition-transform">
                                @else
                                    <div
                                        class="flex h-full w-full items-center justify-center text-3xl font-black text-slate-500 bg-slate-800">
                        ...
                        <div class="flex-1">
                            <div class="flex flex-wrap items-center gap-2 mb-2">
                                <span
                                    class="text-xs font-black uppercase tracking-[0.2em] text-blue-500">{{ $speciality }}</span>
                            </div>
                            <h1 class="text-4xl font-black tracking-tight text-white mb-4">{{ $name }}</h1>

                            <div class="flex flex-wrap items-center gap-3">
                                <div
                                    class="flex items-center gap-1.5 px-3 py-1.5 bg-slate-800 rounded-lg border border-slate-700/50">
                                    <span class="text-amber-400 font-bold">⭐ {{ $rating ?: 'N/A' }}</span>
                                    <span
                                        class="text-[10px] font-bold text-slate-500 uppercase tracking-tighter">Rating</span>
                                </div>
                                <div
                                    class="flex items-center gap-1.5 px-3 py-1.5 bg-slate-800 rounded-lg border border-slate-700/50">
                                    <span class="text-slate-100 font-bold">🩺 {{ $experience }}y</span>
                                    <span
                                        class="text-[10px] font-bold text-slate-500 uppercase tracking-tighter">Experience</span>
                                </div>
                                <div
                                    class="flex items-center gap-1.5 px-3 py-1.5 bg-slate-800 rounded-lg border border-slate-700/50 text-slate-300">
                ...
                <div class="rounded-3xl border border-slate-800 bg-slate-900 p-8 shadow-xl">
                    <div class="  pb-6 flex items-center justify-between">
                        ...
                        <div class="text-right">
                            <p class="text-[10px] font-black text-slate-500 uppercase tracking-widest">Consultation Fee
                            </p>
            ...
            <aside class="space-y-6 lg:sticky lg:top-10 h-fit">
                ...
                <div class="rounded-3xl border border-slate-800 bg-slate-900 p-8 shadow-2xl">
                    <h2 class="text-xs font-black text-slate-500 uppercase tracking-[0.3em] mb-4">About Professional
                    </h2>
                ...
                <!-- Location Details -->
                <div
                    class="rounded-3xl border border-slate-800 bg-blue-600/5 p-8 shadow-xl relative overflow-hidden group border-l-4 border-l-blue-600">
                    <div
                        class="absolute -top-4 -right-4 text-blue-600 opacity-10 transition-transform group-hover:rotate-12">
                    ...
                    <a href="https://www.google.com/maps/search/?api=1&query={{ $doctor->latitude }},{{ $doctor->longitude }}" target="_blank"
